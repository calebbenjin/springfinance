          ...
          <form onSubmit={handleSubmit}>
                ...
                <Row>
                  ...
                  <Col lg='12'>
                    <div className='check-group'>
                      ...
                      <span><input required={true} type='checkbox' name='agree' /> I HEREBY REQUEST SPRING FINANCIAL BANK TO OPEN ACCOUNT IN MY NAME SET FORTH IN THIS APPLICATION.</span>
                    </div>
                  </Col>
                </Row>
              </>
            ...
            <button type="submit" className='login-btn'>
              {loading ? <><Spinner
                  ...
                  role="status"
                  aria-hidden="true"
                /> <span>Opening Account...</span></> : 'Open Account'}
            </button>
          </form>
        </div>
      </div>
